...
describe("Chapter 3", () => {
    ...
    it('Exercise 3.24', () => {
        function startsWith(l, sub) {
            if (R.isEmpty(sub))
                return true;
            if (l[0] === sub[0])
                return startsWith(R.drop(1, l), R.drop(1, sub));
            return false;
        }
    ...
    it('Exercise 3.25', () => {
        ...
        var t3 = new Branch(new Branch(new Leaf(2), new Leaf(10)), new Branch(new Branch(new Leaf(1), new Branch(new Leaf(898), new Leaf(1209))), new Leaf(7908)));
        ...
        function size2(tree) {
            ...
            if (tree.constructor.isBranch())
                return 1 + size2(tree.l) + size2(tree.r);
        }
        ...
        t3 =
            new Branch2(new Branch2(new Leaf2(2), new Leaf2(10)), new Branch2(new Branch2(new Leaf2(1), new Branch2(new Leaf2(898), new Leaf2(1209))), new Leaf2(7908)));
    ...
    it('Exercise 3.26', () => {
        ...
        var t3 = new Branch(new Branch(new Leaf(20), new Leaf(10)), new Branch(new Branch(new Leaf(1), new Branch(new Leaf(898), new Leaf(109))), new Leaf(7908)));
    ...
    it('Exercise 3.28', () => {
        ...
        var t3 = new Branch(new Branch(new Leaf(20), new Leaf(10)), new Branch(new Branch(new Leaf(1), new Branch(new Leaf(898), new Leaf(109))), new Leaf(7908)));
        var t3Plus1 = new Branch(new Branch(new Leaf(21), new Leaf(11)), new Branch(new Branch(new Leaf(2), new Branch(new Leaf(899), new Leaf(110))), new Leaf(7909)));
...
describe("Chapter 4", function () {
    ...
    it('Exercise 4.1', () => {
        ...
        class Maybe {
            ...
            // ````
            getOrElse(def) {
                if (this.constructor.isNothing())
                    return def;
                if (this.constructor.isJust())
                    return this.value;
            }
            // ````scala
        ...
        var lib = {
            getOrElse: R.curry(function (def, maybe) {
                if (maybe.constructor.isNothing())
                    return def;
                if (maybe.constructor.isJust())
                    return maybe.value;
            }),
        ...
        getBirthdayMessage = R.pipe(getAge, lib.map(age => "Happy birthday! You/re now " + age), lib.getOrElse("Could you please update your profile?"));
        expect(getBirthdayMessage(1)).toBe("Happy birthday! You/re now 10");
        expect(getBirthdayMessage(2)).toBe("Could you please update your profile?");
    });
    // ### Exercise 4.2
